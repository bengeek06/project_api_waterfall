...
def upgrade():
    ...
    sa.CheckConstraint("status IN ('created', 'initialized', 'consultation', 'lost', 'active', 'suspended', 'completed', 'archived')", name='check_project_status'),
    sa.CheckConstraint('budget_currency IS NULL OR length(budget_currency) = 3', name='check_currency_code'),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('projects', schema=None) as batch_op:
        batch_op.create_index('idx_projects_company_removed', ['company_id', 'removed_at'], unique=False)
        batch_op.create_index('idx_projects_company_status', ['company_id', 'status'], unique=False)
        batch_op.create_index('idx_projects_customer', ['customer_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('removed_at', sa.DateTime(), nullable=True),
    sa.CheckConstraint("status IN ('planned', 'in_progress', 'completed', 'delayed', 'cancelled')", name='check_deliverable_status'),
    sa.CheckConstraint("type IN ('document', 'software', 'hardware', 'service', 'other')", name='check_deliverable_type'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('deliverables', schema=None) as batch_op:
        batch_op.create_index('idx_deliverables_company', ['company_id'], unique=False)
        batch_op.create_index('idx_deliverables_project_status', ['project_id', 'status'], unique=False)
        batch_op.create_index(batch_op.f('ix_deliverables_company_id'), ['company_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('removed_at', sa.DateTime(), nullable=True),
    sa.CheckConstraint("status IN ('planned', 'in_progress', 'completed', 'delayed', 'cancelled')", name='check_milestone_status'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('milestones', schema=None) as batch_op:
        batch_op.create_index('idx_milestones_company', ['company_id'], unique=False)
        batch_op.create_index('idx_milestones_project_status', ['project_id', 'status'], unique=False)
        batch_op.create_index(batch_op.f('ix_milestones_company_id'), ['company_id'], unique=False)
    ...
    sa.CheckConstraint("action IN ('created', 'updated', 'status_changed', 'deleted', 'restored', 'member_added', 'member_removed', 'role_assigned')", name='check_history_action'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('project_history', schema=None) as batch_op:
        batch_op.create_index('idx_project_history_action', ['action'], unique=False)
        batch_op.create_index('idx_project_history_company', ['company_id'], unique=False)
        batch_op.create_index('idx_project_history_project_date', ['project_id', 'changed_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_history_changed_at'), ['changed_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_history_company_id'), ['company_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_history_project_id'), ['project_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('removed_at', sa.DateTime(), nullable=True),
    sa.CheckConstraint("category IN ('file_operations', 'project_operations', 'member_operations')", name='check_permission_category'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'name', name='uq_project_permission_name')
    )
    with op.batch_alter_table('project_permissions', schema=None) as batch_op:
        batch_op.create_index('idx_project_permissions_category', ['category'], unique=False)
        batch_op.create_index('idx_project_permissions_company', ['company_id'], unique=False)
        batch_op.create_index('idx_project_permissions_project_name', ['project_id', 'name'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_permissions_company_id'), ['company_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_permissions_project_id'), ['project_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'name', name='uq_project_policy_name')
    )
    with op.batch_alter_table('project_policies', schema=None) as batch_op:
        batch_op.create_index('idx_project_policies_company', ['company_id'], unique=False)
        batch_op.create_index('idx_project_policies_project_name', ['project_id', 'name'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_policies_company_id'), ['company_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_policies_project_id'), ['project_id'], unique=False)
    ...
    with op.batch_alter_table('project_roles', schema=None) as batch_op:
        batch_op.create_index('idx_project_roles_company', ['company_id'], unique=False)
        batch_op.create_index('idx_project_roles_project_name', ['project_id', 'name'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_roles_company_id'), ['company_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_roles_project_id'), ['project_id'], unique=False)

    op.create_table('milestone_deliverable_association',
    ...
    op.create_table('policy_permission_association',
    sa.Column('policy_id', sa.UUID(), nullable=False),
    sa.Column('permission_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['permission_id'], ['project_permissions.id'], ondelete='CASCADE'),
    ...
    with op.batch_alter_table('project_members', schema=None) as batch_op:
        batch_op.create_index('idx_project_members_company', ['company_id'], unique=False)
        batch_op.create_index('idx_project_members_role', ['role_id'], unique=False)
        batch_op.create_index('idx_project_members_user', ['user_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_project_members_company_id'), ['company_id'], unique=False)

    op.create_table('role_policy_association',
    sa.Column('role_id', sa.UUID(), nullable=False),
    sa.Column('policy_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['policy_id'], ['project_policies.id'], ondelete='CASCADE'),
